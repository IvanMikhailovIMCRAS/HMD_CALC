...
!**************************************************************************************
	...
	!пары взаимодействующих шариков, находящихся в одной и той же ячейке
	do i = 1, num_cell
		n1 = main_list(i)
		do while (n1.ne.0)
			n2 = att_list(n1)
	...
	!пары взаимодействующих шариков в соседних ячейках
	do i = 1, list1(0)
...
!**************************************************************************************
	...
	do i = 1, num_atom
		! определяем "координату" ячейки
		! тонкий момент, если шарик находится на границе ячейки, 
		! то координата ячейки определяется неправильно, отсюда магическое "0.4999998"
...
!**************************************************************************************
subroutine DB_LIST(N_dbcell,BOX,list1,list2) ! список взаимодействующих ячеек
!**************************************************************************************
...
&                              fxa, fxb, fxc, fya, fyb, fyc, fza, fzb, fzc, Cs) 
!**************************************************************************************
	real(4), intent(in) ::   xa,  xb,  xc,  ya,  yb,  yc,  za,  zb,  zc
	real(4), intent(out) :: fxa, fxb, fxc, fya, fyb, fyc, fza, fzb, fzc, Cs
